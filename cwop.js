...
const formatWxReport = ({ timestamp, longitude, latitude, extension, weather, comment }) => {
...
const formatLogin = (username, password, version='node-red-contrib-aprs 2.0') => {
...
const send = (username, password, packet, timeout=20) => {
